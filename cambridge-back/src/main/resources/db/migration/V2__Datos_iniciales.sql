insert into clasificacion_persona (codigo,nombre,descripcion)
...
insert into tipo_profesor (codigo,nombre,descripcion)
values ('PLANTA','Planta','Planta'),
        ('CONTRA','Contratista','Contratista');
